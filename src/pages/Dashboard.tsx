  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-5 px-6 py-12 text-center sm:py-16">
        ...
        <Pill tone="cyan">
          <Activity className="h-3.5 w-3.5" /> Données live · DofusDude & DofusDB
        </Pill>
      </div>
    </motion.section>
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        ...
        <ArrowUpRight className="h-5 w-5 text-slate-600 transition group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-slate-200" />
      </div>
